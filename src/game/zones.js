...
export const ZONES = {
  ...
  dig: {
    ...
    majors: ['เทคโนโลยีสารสนเทศ', 'เทคโนโลยีธุรกิจดิจิทัล'],
  },
  rob: {
    key: 'rob',
    label: 'Robotics',
    ...
    majors: ['เมคคาทรอนิกส์และหุ่นยนต์', 'ไฟฟ้ากำลัง', 'อิเล็กทรอนิกส์'],
  },
  log: {
    key: 'log',
    label: 'Logistics',
    ...
    majors: ['ช่างยนต์', 'ช่างกล(โรงงาน)', 'เทคนิคเครื่องกล', 'การท่องเที่ยว'],
  },
  bio: {
    key: 'bio',
    label: 'Bio-chem',
    ...
    majors: ['เคมีอุตสาหกรรม', 'ปิโตรเคมี', 'เทคโนโลยีอุตสาหกรรมยาง'],
  },
  med: {
    key: 'med',
    label: 'Medical',
    ...
    majors: ['การโรงแรม', 'การท่องเที่ยว', 'อาหารและโภชนาการ', 'เคมีอุตสาหกรรม'],
  },
